...
- 백로그 등록 요청 (Linear write 확정) -> `skills/linear-issue-manager/SKILL.md`
- Linear 기존 이슈 update 요청 (description append / state 전환) -> `skills/linear-issue-manager/SKILL.md` (Update 분기)
